...
table_ItemNames:itemName "Medical", 13, "Herb"
                ...
                itemName "Healing", 13, "Potion"
                itemName "Goddess", 13, "Tear"
                itemName "Healing", 13, "Rain"
                itemName "Power", 13, "Wine"
